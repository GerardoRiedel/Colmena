...
while($row = mysql_fetch_array($sql))
{
	...
	{
		$link[url] = 'chk_informeEntrevistaTraumatologicoDescarga';
	}
	
	?>
	<tr>
		<td width="201" height="41" align="left" class="letraDocumento" style="padding-left:10px;"><?php echo $row[fecha]; ?>&nbsp;</td>
		<td width="66" align="center" class="letraDocumento">
		<?php
			if($existe != false)
			{
				?>
				<a href="<?php echo $MODULOS; ?>/agenda/<?php echo $link[url]; ?>.php?id=<?php echo $row[id]; ?>"><img src="<?php echo $IMAGENES2; ?>/pdf.png" width="16" height="16" border="0"/></a>
				<?php 
			}
			else
			{
				?>
				<img src="<?php echo $IMAGENES2; ?>/no.png" width="16" height="16" border="0" />
				<?php 
			}
		?>
		</td>
