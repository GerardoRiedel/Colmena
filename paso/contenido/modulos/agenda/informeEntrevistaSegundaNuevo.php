<?php 
	...
	if(existeInformeEntrevista2($idHora, $conectar) != 0)
	{
    ...
    $existe =existeInformeEntrevista2($idHora, $conectar);
...
//
$tipo = tipoUsuario($_SESSION['idUsuario'], $conectar);
if(tipoUsuario($_SESSION['idUsuario'], $conectar) == 'prestador')
{
	?>
	function init()
	{
		window.setInterval(autoguardado2,30000);                  // 30 segundos
...
function autoguardado2()

{

    $.post("chk_informeEntrevistaSegundaAutoNuevo.php", {
        idHora : document.getElementById('idHora').value,
        fecha : document.getElementById('fecha').value,
        ocupacion : document.getElementById('ocupacion').value,
        sexo : document.getElementById('sexo').value,
        edad : document.getElementById('edad').value,
        medicoTratante : document.getElementById('medicoTratante').value,
        nombreMedicoTratante : document.getElementById('nombreMedicoTratante').value,
        ...
        antecedentesMorbidos : document.getElementById('antecedentesMorbidos').value,
        factoresEstresantes : document.getElementById('factoresEstresantes').value,
        anamnesis : document.getElementById('anamnesis').value,
        examenMental : document.getElementById('examenMental').value,
        tratamientoActual : document.getElementById('tratamientoActual').value,
        opinionTratamiento : document.getElementById('opinionTratamiento').value,
        comentarios : document.getElementById('comentarios').value,
        diagnosticoLicenciaMedica : document.getElementById('diagnosticoLicenciaMedica').value,
        opinionSobreDiagnostico : document.getElementById('opinionSobreDiagnostico').value,
        comentariosDLM : document.getElementById('comentariosDLM').value,
        eje1 : document.getElementById('eje1').value,
        eje2 : document.getElementById('eje2').value,
        eje3 : document.getElementById('eje3').value,
        eje4 : document.getElementById('eje4').value,
        eje5 : document.getElementById('eje5').value,
        diasAcumulados : document.getElementById('diasAcumulados').value,
        fechaInicioUL : document.getElementById('fechaInicioUL').value,
        diasReposoIndicados : document.getElementById('diasReposoIndicados').value,
        correspondeReposo : document.getElementById('correspondeReposo').value,
        periodo : document.getElementById('periodo').value,
        comentarios2 : document.getElementById('comentarios2').value,
        ttoRedGes : document.getElementById('ttoRedGes').value,
        lugarRedGes : document.getElementById('lugarRedGes').value,
        enfermedadlaboral:document.getElementById('enfermedadlaboral').value
        }, function(data){
            //// Verificamos la rpta entregada por miscript.php
            msg = document.getElementById("resultadoAutoguardado");
            var ahora = new Date();
          //  var param= document.getElementById('alta').value+' '+document.getElementById('fechaAltasi').value+''+document.getElementById('horaAltasi').value+''+document.getElementById('derivacionsi').value+evaluacionDiaria;
            if (data == 1) {//Bien
	            alertify.success("<span>Informe autoguardado a las "+ahora.getHours()+":"+ahora.getMinutes()+":"+ahora.getSeconds()+"</span>");
             //   msg.innerHTML = "<span style=\"background-color:#093; color:#ffffff;\" class=\"letraNormal\">&nbsp;&nbsp;Informe autoguardado a las "+ahora.getHours()+":"+ahora.getMinutes()+":"+ahora.getSeconds()+"&nbsp;&nbsp;</span>";
            }else{//Mal
	            alertify.error("<span>No fue posible Guardar , espere un instante y vuelva a intentarlo, si el problema persiste informe a DTI! "+ahora.getHours()+":"+ahora.getMinutes()+":"+ahora.getSeconds()+"</span>");
	            //msg.innerHTML = "<span style=\"background-color:#ff0000; color:#ffffff\" class=\"letraNormal\">&nbsp;&nbsp;No se autoguard\u00f3 el informe&nbsp;&nbsp;</span>";
            }
        });
}
...
//	alert('Datos serializados: '+dataString);
    $.ajax({
        type: "POST",
        url: "chk_informeEntrevistaSegundaNuevo.php",
	    contentType: "application/x-www-form-urlencoded;charset=utf-8",
        data: "idHora="+idHora+"&fecha="+fecha+"&ocupacion="+ocupacion+"&sexo="+sexo+"&edad="+edad+"&medicoTratante="+medicoTratante+"&nombreMedicoTratante="+nombreMedicoTratante+"&numeroLicencia="+numeroLicencia+"&antecedentesPersonales="+antecedentesPersonales+"&antecedentesMorbidos="+antecedentesMorbidos+"&factoresEstresantes="+factoresEstresantes+"&anamnesis="+anamnesis+"&examenMental="+examenMental+"&tratamientoActual="+tratamientoActual+"&opinionTratamiento="+opinionTratamiento+"&comentarios="+comentarios+"&diagnosticoLicenciaMedica="+diagnosticoLicenciaMedica+"&opinionSobreDiagnostico="+opinionSobreDiagnostico+"&comentariosDLM="+comentariosDLM+"&eje1="+eje1+"&eje2="+eje2+"&eje3="+eje3+"&eje4="+eje4+"&eje5="+eje5+"&diasAcumulados="+diasAcumulados+"&fechaInicioUL="+fechaInicioUL+"&diasReposoIndicados="+diasReposoIndicados+"&correspondeReposo="+correspondeReposo+"&periodo="+periodo+"&comentarios2="+comentarios2+"&ttoRedGes="+ttoRedGes+"&lugarRedGes="+lugarRedGes+"&enfermedadlaboral="+enfermedadlaboral,

        success: function( data ){
			if (data == 1){
				alertify.success("Informe ha sido Guardado o Modificado.Si necesita ver o imprimir el pdf , utilice el boton ver pdf");
			}else if (data== 0){
				alertify.error("<span>No fue posible Guardar , espere un instante y vuelva a intentarlo, si el problema persiste informe a DTI! "+ahora.getHours()+":"+ahora.getMinutes()+":"+ahora.getSeconds()+"</span>");
...
function popUp(URL)
	{
		...
		eval("page" + id + " = window.open(URL, 'popUp', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=0,width=800,height=700,left=150,top=50');");
	}
...
<form id="form" name="form" method="post" action="chk_informeEntrevistaSegundaNuevo.php">
...
<table width="474" border="0" align="center" cellpadding="0" cellspacing="0" class="borde_tabla" style="border-collapse:collapse;">
		...
		<tr>
			...
			<td width="235" class="letra7" style="padding-left:10px;">
				<input name="fecha" type="text" class="letra7" id="fecha" value="<?php if($existe == 1){echo $fecha;}else
{echo date('d-m-Y');}?>" size="17" maxlength="15" readonly="readonly"/>
		...
		<tr>
			...
			<td class="letra7" style="padding-left:10px;"><label>
				<input name="nombreMedicoTratante" type="text" id="nombreMedicoTratante" value="<?php if($existe == 1){echo $nombreMedicoTratante;}?>" size="35" />
			</label></td>
		</tr>
		<tr>
			...
			<input name="numeroLicencia" type="text" class="letra7" id="numeroLicencia" value="<?php echo $numeroLicencia; ?>" size="15" /></td>
		</tr>
	</table>
	<br />
	<table width="680" border="0" align="center" cellpadding="0" cellspacing="0" class="borde_tabla" style="border-collapse:collapse;">
		...
		<tr>
			<td style="padding-left:10px; padding-top:5px; padding-bottom:5px;"><span class="informeTituloCampo">Antecedentes Personales</span><br />
			  ...
			  <textarea name="antecedentesPersonales" cols="120" rows="8" class="letra7" id="antecedentesPersonales"><?php if($existe == 1){echo $antecedentesPersonales;}?></textarea>
           ...
           <input type="button" name="grabaCampos" id="grabaCampos" value="grabar" onclick="grabaCamposInforme();" /> <br />
            ...
            <textarea name="antecedentesMorbidos" cols="120" rows="8" class="letra7" id="antecedentesMorbidos"><?php if($existe == 1){echo $antecedentesMorbidos;}?></textarea>
...
<span id="sprytextarea4">
				<textarea name="factoresEstresantes" cols="120" rows="8" class="letra7" id="factoresEstresantes"><?php if($existe == 1){echo $factoresEstresantes;}?></textarea>
		    <span class="letra7" id="countsprytextarea4">&nbsp;</span><span class="textareaMaxCharsMsg">*</span></span>           <input type="button" name="grabaCampos2" id="grabaCampos2" value="grabar" onclick="grabaCamposInforme();" /><br />
				...
				<textarea name="anamnesis" cols="120" rows="8" class="letra7" id="anamnesis"><?php if($existe == 1){echo $anamnesis;}?></textarea>
				...
				<textarea name="examenMental" cols="120" rows="8" class="letra7" id="examenMental"><?php if($existe == 1){echo $examenMental;}?></textarea>
			...
			<tr>
			  <td style="padding-left:10px; padding-top:5px; padding-bottom:5px;">
				...
				<textarea name="tratamientoActual" cols="120" rows="8" class="letra7" id="tratamientoActual"><?php if($existe == 1){echo $tratamientoActual;}?></textarea>
				<span class="letra7" id="countsprytextarea5">&nbsp;</span><span class="textareaMaxCharsMsg">*</span></span>           <p>
				  <input type="button" name="grabaCampos" id="grabaCampos5" value="grabar" onclick="grabaCamposInforme();" />
				<p><span class="informeTituloCampo">Paciente Refiere Tatamiento en red  GES :</span> <span class="informeTituloCampo">
                <label>
                  <select name="ttoRedGes" class="letraNoticias" id="ttoRedGes"  onchange="cambiarDonde(form);">
                      <?php
						if($existe == 1)
                        {
                            ?>
                            <option value="<?php echo $ttoRedGes; ?>"><?php echo $ttoRedGes; ?></option>
                        <?php
                        }
						?>
				...
				<table  id="tabladonde" name="tabladonde" width="276" border="0" style="<?php if($ttoRedGes != 'SI'){  ?>display:none;<?php } ?>border:none;">
				    <tr>
				      <td width="270"><span style="padding-left:15px;"><span class="informeTituloCampo">Lugar </span><br />
                   <label>
                            <select name="lugarRedGes" disabled="disabled" id="lugarRedGes"  <?php
									if($existe == 1)
									{
										if($ttoRedGes != 'SI')
										{
											?><?php }}?>>
                              <option value="<?php echo $lugarRedGes; ?>"><?php echo $lugarRedGes; ?></option>
                              <option value="REDGESAM">REDGESAM</option>
                              <option value="OTRO">OTRO</option>
                              <?php 
									if($existe == 1)
									{
                          ...
                          <input type="button" name="grabaCampos22" id="grabaCampos22" value="grabar" onclick="grabaCamposInforme();" />
                          <br />
                          <br />
                      </td>
			        </tr>
                ...
                <span class="informeTituloCampo">Opinión Sobre Tratamiento Farmacológico</span><br />
				  ...
				  <textarea name="comentarios" cols="120" rows="8" class="letra7" id="comentarios"><?php if($existe == 1){echo $comentarios;}?>
				</textarea>
			...
			<tr>
				...
				<textarea name="diagnosticoLicenciaMedica" cols="120" rows="8" class="letra7" id="diagnosticoLicenciaMedica"><?php if($existe == 1){echo $diagnosticoLicenciaMedica;}?></textarea>
                ...
                <label>
                  <textarea name="comentariosDLM" cols="120" rows="3" class="letra7" id="comentariosDLM"><?php if($existe == 1){echo $comentariosDLM;}?></textarea>
...
<span class="textfieldMinValueMsg">El valor introducido es inferior al mínimo permitido. Si no tiene el dato, déjelo en blanco.</span></span>
           <input type="button" name="grabaCampos16" id="grabaCampos16" value="grabar" onclick="grabaCamposInforme();" /><br />
				...
				<input name="fechaInicioUL" type="text" id="fechaInicioUL" value="<?php if($existe == 1){echo $fechaInicioUL;}?>" size="17" maxlength="15" readonly="readonly"/>
				...
				<label>
					<input name="diasReposoIndicados" type="text" id="diasReposoIndicados" title="header=[Si no tiene información deje en blanco] body=[]" size="3" value="<?php if($existe == 1){echo $diasReposoIndicados;}?>"/>
				</label>
				...
				<textarea name="comentarios2" cols="117" rows="8" class="letra7" id="comentarios2"><?php if($existe == 1)
{echo $comentarios2;}?></textarea>
				<span class="textareaRequiredMsg">*</span></span>           	    
				  
				    <input type="button" name="grabaCampos21" id="grabaCampos21" value="grabar" onclick="grabaCamposInforme();" />
				    <br />		    
				    <br/>
				  <span class="informeTituloSeccion">IV)</span>			      
				   
				    
				  <span class="informeTituloCampo">Enfermedad de Origen Laboral</span>
				  <br />  
				   <br />  
	...
	<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td align="center">
				...
				<label>
				<input type="button"  value="Guardar" onClick="grabaCamposInforme();" />
				</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<label>
                <input type="button" onclick="popUp('<?php echo $MODULOS; ?>/agenda/chk_informeEntrevistaSegundaDescargaNuevo.php?id=<?php echo $idHora;?>')" value="Ver PDF" />
				</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<?php
				if(tipoUsuario($_SESSION['idUsuario'], $conectar) != 'prestador')				
				{ ?>
