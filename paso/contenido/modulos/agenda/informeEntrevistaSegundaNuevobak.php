...
function verpdf(idHora)
{
    window.location.href = '<?php echo $MODULOS; ?>/agenda/chk_informeEntrevistaSegundaDescargaNuevo.php?id='+ idHora;
}
...
function autoguardado()
{
    ...
    $.post("chk_informeEntrevistaSegundaAutoNuevo.php", {
        ...
        if (data == 1) {//Bien
            ...
            msg.innerHTML = "<span style=\"background-color:#ff0000; color:#ffffff\" class=\"letraNormal\">&nbsp;&nbsp;No se autoguard� el informe&nbsp;&nbsp;</span>";
        }
    });
}
...
<br />
<form id="form" name="form1" method="post" action="chk_informeEntrevistaSegundaNuevo.php">
			...
			<tr>
			  <td style="padding-left:10px; padding-top:5px; padding-bottom:5px;">
				...
				<span class="letra7" id="countsprytextarea5">&nbsp;</span><span class="textareaMaxCharsMsg">*</span></span>           <p>
				  <input type="button" name="grabaCampos5" id="grabaCampos5" value="grabar" onclick="grabaCamposInforme();" />                
				<p><span class="informeTituloCampo">Paciente Refiere Tatamiento en red  GES :</span> <span class="informeTituloCampo">
                <label>
                  <select name="ttoRedGES" class="letraNoticias" id="ttoRedGES"  tabindex="18" onchange="cambiarDonde(form);">
				...
				<table  id="tabladonde" width="276" border="0" style="<?php if($ttoRedGES != 'SI'){  ?>display:none;<?php } ?>border:none;">
				    <tr>
                ...
                <span class="informeTituloCampo">Opinión Sobre Tratamiento Farmacológico</span><br />
				  ...
				  <textarea name="comentarios" cols="120" rows="8" class="letra7" id="comentarios"><?php if($existe == true){echo $comentarios;}?>
				</textarea>
	...
	<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td align="center">
				...
				{ ?>
                    <input type="button"  onclick="verpdf(<?php echo $idHora; ?>)" value="Ver Pdf" />
