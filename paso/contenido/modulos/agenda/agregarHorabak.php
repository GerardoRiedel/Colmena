...
<script>
	...
	function validarForm(form)
	{
		...
		else if( form.isapre.options[select].value ==""  )
	...
	//	else if(repetido >= '1' && rutisapre != '1' && hora >0  )
	//	{
	//		alert('Paciente Tiene hora Previa presione aceptar');
	//		return false;
	...
	function actualiza(){
		...
		var ruthora = <?php echo $rutPaciente ;?> ;
...
<label>
				<input name="dv" type="text" id="dv" size="1" readonly value=""/>
			  </label> 
					<?php 
				}
				else
...
?> onfocus=""/>
		...
		<tr>
			...
			<td class="letra7" style="padding-left:10px;">
				<label>
				<input name="apellidoPaterno" type="text" class="letra7" id="apellidoPaterno" onclick="" value="<?php echo utf8_encode($apellidoPaternoPaciente); ?>" size="30" <?php
				if($idHora != NULL and diferenciaHoraActualHora($idHora, $conectar) > 48 and tipoUsuario($_SESSION['idUsuario'], $conectar) != 'administrador')
				{
					?>readonly="readonly"<?php
				}
	...
	<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td align="center">
				...
				{
					?>
					<input name="idHora" type="text" id="idHora" value="<?php echo $idHora; ?>" />
					<?php 
				}
				else
				{
				...
				<input id="reservar" name="Submit" type="submit" value="Reserva"  class="boton" value="1" onclick="llamadaHP();"  onmouseover="llamadaHP();"  />
				<input id="modifica" name="Submit" type="submit" value="Modifica" class="boton" value="1" onmouseover="llamadaHP();" onclick="return actualiza();" />
