...
if ($fecha >= '2014-08-15' )
{
	...
	if(file_exists('../../../../agenda/contenido/templates/defecto/imagenes/firmas/'.$nombreImagen) == true)
	{ 
		//g bvredimensionar_jpeg('../../templates/defecto/imagenes/firmas/'.$nombreImagen, '../../templates/defecto/imagenes/firmas/'.$nombreImagen, 250, 120, 100);

			$pdf->Image("../../../../agenda/contenido/templates/defecto/imagenes/firmas/$nombreImagen", 0, 100, 0);
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
 <?php 
    ...
    if(file_exists('../../../../agenda/contenido/templates/defecto/imagenes/firmas/'.$idPrestador.'.jpg') == true)
    {
    $idPrestadorIMG = '<img src="../../../../agenda/contenido/templates/defecto/imagenes/firmas/'.$idPrestador.'.jpg" width="354" height="170"/>';
    }
    else {
      $idPrestadorIMG = '';  
    }
	...
	<tr>
		<td height="51" align="left" valign="top">
			<table width="600" height="654" border="0" cellpadding="0" cellspacing="0">
				<tr>
				  <td height="62" colspan="2" align="left" valign="top">&nbsp;&nbsp;&nbsp;<img  src="../../contenido/templates/defecto/imagenes/logoDocumentos.jpg" width="80" height="62" /></td>
...
Este certificado se extiende a petici&oacute;n de <strong>Colmena</strong> para los fines que estime conveniente.</span></td>
	...
	if ($destino == 'I') {
		...
		//$html2pdf->Output('Certificado'.$archivo.'.pdf', "I");
                $carpeta ='agenda/ws/colmena/informes/informes/'.$archivo.'.pdf';
...
function funcionInformeAtraso($idHora)
{
	...
	<tr>
		<td height="51" align="left" valign="top">
			<table width="600" height="654" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td height="34" colspan="3" align="center" valign="bottom" class="letraDocumentoTitulo"><u>CERTIFICADO DE ATRASO A PERITAJE</u></td>
				</tr>
				<tr>
					<td height="34" colspan="3" align="left" valign="bottom">&nbsp;</td>
				</tr>
				<tr>
					<td width="21%" height="34" align="left" valign="bottom"><p class="letraDocumento" align="justify">&nbsp;</p></td>
					<td width="57%" align="left" valign="bottom"><span class="letraDocumento">Por medio de la presente certificamos que <strong>'.utf8_encode($nombreCompletoPaciente).'</strong>, RUT <strong>'. $rutPaciente.'</strong>, '. $glosaNumlic.'  asiste a Evaluaci&oacute;n Psiquiatrica de acuerdo a la citaci&oacute;n enviada por su Isapre Colmena, para el d&iacute;a '. $dia.' de '. MesPalabra($mes).' de '. $ano.' a las '.$hora.':'.$minutos.' hrs., en la ciudad de 
	'.$ciudad.'. Sin embargo, debido al retraso de m&aacute;s de 15 minutos en la hora de llegada, no fue posible realizar la antes mencionada evaluaci&oacute;. 
	<br />
							<br />
Este certificado se extiende a petici&oacute;n de <strong>Colmena</strong> para los fines que estime conveniente.</span></td>
					<td height="34" align="left" valign="bottom">&nbsp;</td>
