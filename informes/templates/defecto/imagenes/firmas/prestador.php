...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="borde_tabla" id="cambio_color" style="border-collapse:collapse;">
	<tr>
		...
		<?php } ?>
		 ...
		 {	?>
			<td width="6%" align="center" bgcolor="#DFEFFF" class="tituloTablas">Resumen.</td>
		<?php } ?>
...
*/
		...
		{			
			...
			if(tipoUsuario($_SESSION['idUsuario'], $conectar) == 'isapre' or tipoUsuario($_SESSION['idUsuario'], $conectar) == 'Compin' )
			{
			...
			<tr style="cursor:pointer; background-color:<?php echo $color; ?>" <?php echo $tituloSi; ?>>
				...
				<td align="left" class="letraTablaHoras" style="padding-left:5px;" 
				<?php 
        ...
        <td align="center" class="letra7">
            ...
            <td align="center">
				...
				if(tipoUsuario($_SESSION['idUsuario'], $conectar) == 'isapre' )
				{
					...
					if($datosInforme['fechaPublicacion'] != '0000-00-00' &&  $datosInforme['publicado'] == 'SI' && diferenciaHoraActualHora($idHora, $conectar) >= 24 )
	
					{
						?> <a href="<?php echo $MODULOS; ?>/agenda/chk_ResumeninformeEntrevistaDescarga.php?id=<?php echo $idHora; ?>" title="Resumen Informe " rel="gb_page[700, 600]"><img src="<?php echo $IMAGENES; ?>/pdf.png" width="16" height="16" border="0" title="header=[Informe Publicado] body=[]"/></a><?php
					}
				}
				//
				//SI EL PACIENTE TIENE PERITAJES ANTERIORES
