...
//echo $respuesta;die;
                        ...
                        ELSEIF($check[0]->fecha < $fechaPublicacion){
                            ...
                            $mensaje = 'Estimadas,<br><br>Informe diario de peritajes no publicados con más de 5 días:<br><br>Ciudad: '.$ciudad.'<br>Prestador: '.strtoupper($check[0]->nomMedico).' '.strtoupper($check[0]->apeMedico).'<br>Paciente: '.strtoupper($check[0]->nomPac).' '.strtoupper($check[0]->apePac).'<br>Hora: '.$hora;
