...
$usuario=nombreUsuario($idUsuario, $conectar);
...
<body <?php if(tipoUsuario($_SESSION['idUsuario'], $conectar) != '' ){?>onLoad="init();"<?php }?>>
	...
	<tr>
		<td width="19%" align="center" valign="top" style="padding-right:20px;" class="fondoTablaIzquierdaHoras">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align="left" class="letraDocumento" style="padding-left:15px;">
		<img src="<?php echo $IMAGENES; ?>/perfil16.png" width="20" height="20" />
        <span class="letraDocumento"><?php echo tipoUsuario($idUsuario, $conectar);?></span> <input type="hidden" id="tipou" name="tipou" value="<?php echo tipoUsuario($idUsuario, $conectar);?>"/>
                    <img src="<?php echo $IMAGENES; ?>/usuario.png" width="16" height="16" />
                        <?php echo $usuario  ;?>
                    </td>
				</tr>
			</table>			
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<tr>
						<td height="32" align="center" valign="top"><a href="<?php echo $MODULOS; ?>/informes/listadoPeritajesentrefechas.php" title="Diarios" rel="gb_pageset[800.600]">
								<input name="Submit2" type="submit" class="boton" value="Peritajes x Fecha" title="header=[Informes] body=[* Buscar Peritajes entre fechas]" style="cursor:pointer;"/>
							</a></td>
					</tr>
			<?php	}?>
				...
				?>
					...
					<tr>
				<td><div style="position:relative; bottom:-10; left:0; margin-bottom:20px; margin-left:60px;"><img src="<?php echo $IMAGENES; ?>/telefono.png" heigth="14" width="14"/> Soporte: 2 2406 8797</div></td>
				</tr>
				</tr>
			</table>
		</td>
